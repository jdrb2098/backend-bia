...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'web-production-e5dc.up.railway.app', 'backend-bia-production.up.railway.app', 'backend-bia-production-933f.up.railway.app']
...
EMAIL_PORT = 587
EMAIL_HOST_USER='biamacareniacorma@outlook.com'
EMAIL_HOST_PASSWORD='macarenia1234'
